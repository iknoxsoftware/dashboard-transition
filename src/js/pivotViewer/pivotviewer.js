...
var apiPath = "http://localhost/pivotviewer/";
var reportLoaded = new Event('report-loaded');
        ...
        $.ajax({
            ...
            success: function (xml) {
                ...
                if (facetItems.length == 1) {
                    ...
                    collection.ImageBase = formatImageBase($(facetItems[0]).attr("ImgBase"));
...
PivotViewer.Models.Loaders.JSONLoader = PivotViewer.Models.Loaders.ICollectionLoader.subClass({
    ...
    LoadCollection: function (collection) {
        ...
        .done(function(data) {
            ...
            if (data.Items.ImgBase != undefined) collection.ImageBase = formatImageBase(data.Items.ImgBase);
...
PivotViewer.Views.GraphView = PivotViewer.Views.TileBasedView.subClass({
    ...
    GetButtonImage: function () {
        return 'assets/pivot-viewer-view/GraphView.png';
    },
    GetButtonImageSelected: function () {
        return 'assets/pivot-viewer-view/GraphViewSelected.png';
    },
...
PivotViewer.Views.GridView = PivotViewer.Views.TileBasedView.subClass({
    ...
    GetButtonImage: function () {
        return 'assets/pivot-viewer-view/GridView.png';
    },
    GetButtonImageSelected: function () {
        return 'assets/pivot-viewer-view/GridViewSelected.png';
    },
    GetViewName: function () {
        return 'Grid View';
    },
...
PivotViewer.Views.MapView = PivotViewer.Views.IPivotViewerView.subClass({
    ...
    GetUI: function () { return ''; },
    GetButtonImage: function () {
        return 'assets/pivot-viewer-view/MapView.png';
    },
    GetButtonImageSelected: function () {
        return 'assets/pivot-viewer-view/MapViewSelected.png';
    },
...
PivotViewer.Views.MapView2 = PivotViewer.Views.IPivotViewerView.subClass({
	...
	this.osm = new L.TileLayer(osmUrl, {attribution: osmAttrib});		
        ...
        // create the icon set
        var RedIcon = L.Icon.Default.extend({options: {iconUrl: 'js/pivotViewer/images/Red.png' }});
        this.icons.push(RedIcon);
        var RedDotIcon = L.Icon.Default.extend({options: {iconUrl: 'js/pivotViewer/images/RedDot.png' }});
        this.iconsSelected.push(RedDotIcon);
        var YellowIcon = L.Icon.Default.extend({options: {iconUrl: 'js/pivotViewer/images/Yellow.png' }});
        this.icons.push(YellowIcon);
        var YellowDotIcon = L.Icon.Default.extend({options: {iconUrl: 'js/pivotViewer/images/YellowDot.png' }});
        this.iconsSelected.push(YellowDotIcon);
        var GreenIcon = L.Icon.Default.extend({options: {iconUrl: 'js/pivotViewer/images/DarkGreen.png' }});
        this.icons.push(GreenIcon);
        var GreenDotIcon = L.Icon.Default.extend({options: {iconUrl: 'js/pivotViewer/images/DarkGreenDot.png' }});
        this.iconsSelected.push(GreenDotIcon);
        var BlueIcon = L.Icon.Default.extend({options: {iconUrl: 'js/pivotViewer/images/Blue.png' }});
        this.icons.push(BlueIcon);
        var BlueDotIcon = L.Icon.Default.extend({options: {iconUrl: 'js/pivotViewer/images/BlueDot.png' }});
        this.iconsSelected.push(BlueDotIcon);
        var PurpleIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/Purple.png' }});
        this.icons.push(PurpleIcon);
        var PurpleDotIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/PurpleDot.png' }});
        this.iconsSelected.push(PurpleDotIcon);
        var OrangeIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/Orange.png' }});
        this.icons.push(OrangeIcon);
        var OrangeDotIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/OrangeDot.png' }});
        this.iconsSelected.push(OrangeDotIcon);
        var PinkIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/Pink.png' }});
        this.icons.push(PinkIcon);
        var PinkDotIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/PinkDot.png' }});
        this.iconsSelected.push(PinkDotIcon);
        var SkyIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/Sky.png' }});
        this.icons.push(SkyIcon);
        var SkyDotIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/SkyDot.png' }});
        this.iconsSelected.push(SkyDotIcon);
        var LimeIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/Lime.png' }});
        this.icons.push(LimeIcon);
        var LimeDotIcon = L.Icon.Default.extend({options: { iconUrl: 'js/pivotViewer/images/LimeDot.png' }});
...
PivotViewer.Views.TimeView = PivotViewer.Views.IPivotViewerView.subClass({
    ...
    GetUI: function () { return ''; },
    GetButtonImage: function () {
        return 'assets/pivot-viewer-view/TimeView.png';
    },
    GetButtonImageSelected: function () {
        return 'assets/pivot-viewer-view/TimeViewSelected.png';
    },
        ...
        for (var facet = 0; facet < this.timeFacets.length; facet++) {
            for (var item = 0; item < this.timeFacets[facet].eventsData.length; item++) {
                if (this.timeFacets[facet].eventsData[item]._id == this.selectedItemId) {
                    this.timeFacets[facet].eventsData[item]._icon = "js/pivotViewer/timeline_js/images/dark-red-circle.png";
                } else 
                    this.timeFacets[facet].eventsData[item]._icon = "js/pivotViewer/timeline_js/images/blue-circle.png";
            }
        }
...
PivotViewer.Views.TableView = PivotViewer.Views.IPivotViewerView.subClass({
    ...
    Setup: function (width, height, offsetX, offsetY, tileMaxRatio) {
        ...
        $('.pv-viewpanel').append("<div style='visibility:hidden;position:relative;' id='pv-table-loader'><img src='assets/pivot-viewer-view/loading.gif'></img></div>");
    ...
    GetButtonImage: function () {
        return 'assets/pivot-viewer-view/TableView.png';
    },
    GetButtonImageSelected: function () {
        return 'assets/pivot-viewer-view/TableViewSelected.png';
    },
    GetViewName: function () {
        return 'Table View';
    },
    ...
    CreateTable: function ( currentFilter, selectedFacet, sortKey, sortReverse ) {
        ...
        if (sortReverse) {
            sortImage = "assets/pivot-viewer-view/sort-up.png";
            //offset = +40;
        } else {
            sortImage = "assets/pivot-viewer-view/sort-down.png";
            //offset = -40;
        }
                   ...
                   if ( showAllFacets || selectedFacet == 'Description') {
                      ...
                      if (this.tiles[j].facetItem.Description) {
                          ...
                          if (this.tiles[j].facetItem.Href) {
                              tableRows.push({key: sortKeyValue, value: "<tr class='pv-tableview-" + oddOrEven +"'><td id='pv-key' title='Toggle item selection' style='color:#009933;cursor:pointer'>" + entity + " " + "<a href=" + this.tiles[j].facetItem.Href.replace(/'/g, "%27") + " target=\"_blank\"><img style='cursor:default;' id='pv-linkout' title='Follow the link' title='Follow the link' src='assets/pivot-viewer-view/goout.gif'></img></a></a></td><td id='pv-facet' title='Show only this predicate' style='color:#009933;cursor:pointer'>Description</td><td id='pv-value'>" + this.tiles[j].facetItem.Description + "</td></tr>"});
                          } else {
                           ...
                           for (l = 0; l < this.tiles[j].facetItem.Facets[k].FacetValues.length; l++) {
                              ...
                              if (this.IsFilterVisible (attribute)) {
                                  ...
                                  if (this.tiles[j].facetItem.Href) {
                                      // Value is uri
                                      if (this.IsUri(value))
                                          tableRows.push({key: sortKeyValue, value: "<tr class='pv-tableview-" + oddOrEven +"'><td id='pv-key' title='Toggle item selection' style='color:#009933;cursor:pointer'>" + entity + " " + "<a href=" + this.tiles[j].facetItem.Href.replace(/'/g, "%27") + " target=\"_blank\"><img style='cursor:default;' id='pv-linkout' title='Follow the link' src='assets/pivot-viewer-view/goout.gif'></img></a></td><td id='pv-facet'  title='Show only this predicate' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value' title='Filter on this value' style='color:#009933;cursor:pointer'>" + value + " " + "<a href=" + value + " target=\"_blank\"><img style='cursor:default;' id=pv-linkout' title='Follow the link' src='assets/pivot-viewer-view/goout.gif'></img></a></td></tr>"});
                                      else
                               ...
                               for (l = 0; l < this.tiles[j].facetItem.Facets[k].FacetValues.length; l++) {
                                  ...
                                  if (this.IsFilterVisible (attribute)) {
                                      ...
                                      if (this.tiles[j].facetItem.Href) {
                                          // Value is uri
                                          if (this.IsUri(value))
                                              tableRows.push({key: sortKeyValue, value: "<tr class='pv-tableview-" + oddOrEven +"'><td id='pv-key' title='Toggle item selection' style='color:#009933;cursor:pointer'>" + entity + " " + "<a href=" + this.tiles[j].facetItem.Href.replace(/'/g, "%27") + " target=\"_blank\"><img style='cursor:default;' id='pv-linkout' title='Follow the link' src='assets/pivot-viewer-view/goout.gif'></img></a></td><td id='pv-facet' title='Clear predicate selection' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value' class='tooltipinter 'title='Filter on this value' style='color:#009933;cursor:pointer'>" + value + " " + "<a href=" + value + " target=\"_blank\"><img style='cursor:default;' id=pv-linkout' title='Follow the link' src='assets/pivot-viewer-view/goout.gif'></img></a></td></tr>"});
                                           else
                                              tableRows.push({key: sortKeyValue, value: "<tr class='pv-tableview-" + oddOrEven +"'><td id='pv-key' title='Toggle item selection' style='color:#009933;cursor:pointer'>" + entity + " " + "<a href=" + this.tiles[j].facetItem.Href.replace(/'/g, "%27") + " target=\"_blank\"><img style='cursor:default;' id='pv-linkout' title='Follow the link' src='assets/pivot-viewer-view/goout.gif'></img></a></td><td id='pv-facet' title='Clear predicate selection' style='color:#009933;cursor:pointer'>" + attribute + "</td><td id='pv-value' title='Filter on this value' style='color:#009933;cursor:pointer'>" + value + "</td></tr>"});
                                      } else {
                                          // Value is uri
...
PivotViewer.Views.DeepZoomImageController = PivotViewer.Views.IImageController.subClass({
    ...
    Setup: function (deepzoomCollection) {
        ...
        $.ajax({
            type: "GET",
            url: apiPath + deepzoomCollection,
            dataType: "xml",
            success: function (xml) {
        ...
        for (var i = 0; i < this._items.length; i++) {
            if (this._items[i].ItemId == id) {
                ...
                if ((this._items[i].Levels == undefined || this._items[i].Levels.length == 0) && !this._zooming) {
                    //create 0 level
                    var imageList = this.GetImageList(i, apiPath + this._baseUrl + "/" + this._items[i].BasePath + this._items[i].DZId + "_files/6/", 6); ;
                    ...
                    var imageList = this.GetImageList(i, apiPath + this._baseUrl + "/" + this._items[i].BasePath + this._items[i].DZId + "_files/" + level + "/", level);
                    var newLevel = new PivotViewer.Views.LoadImageSetHelper();
                    newLevel.LoadImages(imageList);
                ...
                for (var j = level; j > -1; j--) {
                    ...
                    if (j == level && this._items[i].Levels[j] == undefined && !this._zooming) {
                        ...
                        var imageList = this.GetImageList(i, apiPath + this._baseUrl + "/" + this._items[i].BasePath + this._items[i].DZId + "_files/" + j + "/", j);
                        //create level
                        var newLevel = new PivotViewer.Views.LoadImageSetHelper();
                        newLevel.LoadImages(imageList);
...
(function ($) {
    ...
    var methods = {
        ...
        init: function (options) {
            ...
            $.getJSON("js/pivotViewer/defaults")
            .always( function (defaultOptions) {
                ...
                if ( _mapService == "Google") {
                    ...
                    script.src = "js/pivotViewer/wicket-gmap3.min.js";
                    document.body.appendChild(script);
                } else {
                    // Load the leaflets plugin for wicket
                    var script = document.createElement("script");
                    script.type = "text/javascript";
                    script.src = "js/pivotViewer/wicket-leaflet.min.js";
                    document.body.appendChild(script);
                }
    ...
    InitPreloader = function () {
        //http://gifmake.com/
        // _self.append("<div class='pv-loading'><img src='assets/pivot-viewer-view/loading.gif' alt='Loading' /><span>Loading...</span></div>");
...
function formatImageBase(value) {
    return "PivotViewer/" + value;
}
function doneLoading() {
    //$('.pv-loading').remove();
    window.dispatchEvent(reportLoaded);
}